...
enum Keys
{
	...
	KEY_F24 = 313,
	KEY_F25 = 314,
	KEY_KP_0 = 320,	// Numpad 0
	KEY_KP_1 = 321,	// Numpad 1
	KEY_KP_2 = 322,	// Numpad 2
	KEY_KP_3 = 323,	// Numpad 3
	KEY_KP_4 = 324,	// Numpad 4
	KEY_KP_5 = 325,	// Numpad 5
	KEY_KP_6 = 326,	// Numpad 6
	KEY_KP_7 = 327,	// Numpad 7
	KEY_KP_8 = 328,	// Numpad 8
	KEY_KP_9 = 329,	// Numpad 9
	KEY_KP_DECIMAL = 330,	// Numpad .
	KEY_KP_DIVIDE = 331,	// Numpad /
	KEY_KP_MULTIPLY = 332,	// Numpad *
	KEY_KP_SUBTRACT = 333,	// Numpad -
	KEY_KP_ADD = 334,	// Numpad +
	KEY_KP_ENTER = 335,	// Numpad enter
	KEY_KP_EQUAL = 336,	// Numpad =
	KEY_LEFT_SHIFT = 340,
...
private:
	...
	static std::unordered_map<int, bool> keysDownThisFrame;
	static std::unordered_map<int, bool> keysUpThisFrame;
};